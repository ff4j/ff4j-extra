...
import org.ff4j.springboot.FF4jSpringBootApplication;
...
@SpringApplicationConfiguration(classes = FF4jSpringBootApplication.class)
...
public class SampleJerseyApplicationTests {
	...
	@Test
	public void testSampleGetTrade() {
		ResponseEntity<String> entity = 
				this.restTemplate.getForEntity("http://localhost:" + this.port + "/api/trades/info", 
				String.class);
	...
	public void returnsAllPages() {
	    // act
	    ResponseEntity<Page<Trade>> responseEntity = getCustomers(
	            "http://localhost:9000/customer"
	    );
	    Page<Trade> customerPage = responseEntity.getBody();
	    // assert
