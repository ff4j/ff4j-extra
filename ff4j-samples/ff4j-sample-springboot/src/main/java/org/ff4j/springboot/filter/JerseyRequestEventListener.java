...
@Provider
public class JerseyRequestEventListener implements RequestEventListener, FF4jHeaderParams {
	...
	public void onEvent(RequestEvent reqEvt) {
    	switch(reqEvt.getType()) {
    		...
    		case REQUEST_FILTERED:
    			correlationID = reqEvt.getContainerRequest().getHeaderString(CORRELATION_ID);
